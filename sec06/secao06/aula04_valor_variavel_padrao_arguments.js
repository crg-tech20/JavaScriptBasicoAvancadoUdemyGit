...
function somar3(num1, num2, num3){
    num1 = isNaN(num1) ? 1 : num1;  // Operador ternário
...
console.log(somar5('a', 'b', 'c')); // -1
console.log(somar5(true, false, 'c')); // -1
console.log(somar5(2, true, false)); // -1

// Number.parseInt();
// Number.toString();
// let nu = Number.parseFloat('1.2')
// console.log(nu);
