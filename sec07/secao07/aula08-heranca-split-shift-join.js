...
class Pessoa{
    ...
    // Métodos extras na forma de get
    get nome_completo(){
    ...
    set nome_completo(nome_completo){
        ...
        // junta os elementos restantes do array em uma string separando cada elemento por espaço
        this._sobrenome = nome_completo.join(' ');
    }

    imprimir_dados(){
        console.log(`${this.nome} ${this.sobrenome}`); 
        // Faz acesso ao método get, pois o atributo é _nome e _sobrenome
    }
...
c1.nome_completo = 'Xuxa Meneguel da Silva';
...
console.log(f1.nome_completo);  // Usando o método get da classe pessoa
console.table(f2);