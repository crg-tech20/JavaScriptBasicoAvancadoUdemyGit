...
// TODO - Instanciação de Objetos - Forma 1
...
// curso['qtd_alunos'] = 999;  // Adicionando atributos dinamicamente

// console.log(curso);

/* Resp: { nome: 'Programação em JavaScript', preco: 27.99 }
         { nome: 'Programação em JavaScript', preco: 27.99, qtd_alunos: 999 }
*/

// TODO - Deletando atributos do objeto.
...
// TODO - Instanciação de Objetos - Forma 2 - Objeto Literal
const programa = {
    nome: 'Photoshop',
    preco: 8999.99,
    fabricante: {
...
// TODO - Instanciação de Objetos - Forma 3 - Objeto Literal
...
// TODO - Instanciação de Objetos - Forma 4 - Função Construtora
...
// TODO - Instanciação de Objetos - Forma 5 - Objeto a partir das nossas classes
...
// p1.nome = 'Xuxa';  // Usando o set do objeto Pessoa
// console.log(p1);
